...
1. 一个软件开发过程中会产生很多工作产品artifacts/work product，但是并不是所有产品都是值得管理的，要去掉一些不那么重要的产品，确保重要的（为了让交付有完整性的）工作产品被管理。其实就是为了减少工作量。
...
**这个知识点不知道放在哪里，因为DAR中需要大量的文档和评估所以就姑且放在这里**
1. 如何评价 "CMMI 是官僚、重文档的"这一说法
```
这是对CMMI的一种误解。
