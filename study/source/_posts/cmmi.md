...
>CMMI 是模型的有关误解:所谓 CMMI 模型，是指 CMMI 刻画了软件团队/组织从不成熟到 成熟的每个阶段的特征——即所谓的路线图 roadmap。与实际的开发模型没关系。这个路线图其实也是 CMMI 模型最为精华的部分，甚至都可以在很多其他的领域借鉴。 
...
|4.16|PMC、MA、PPQA、TS、DAR、CAR新增一个知识点、CMMI与过程部分增加很多知识点|